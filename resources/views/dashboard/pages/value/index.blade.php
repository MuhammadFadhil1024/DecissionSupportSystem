                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      <table id="example1" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th class="dt-head-center" style="width: 10px">No</th>
                          ...
                          @foreach ($alternatives as $index => $alternative)
                            <tr>
                              ...
                              <td class="dt-body-center">
                                @if ($alternative->values->isEmpty())
                                  <div class="d-inline-block">
                                        <a href="/dashboard/process/category/{{ $categories_id }}/value/create/{{ $alternative->id }}" class="btn btn-block btn-primary">Insert Value</a>
                                  </div>
                                @else
                                  <div class="d-inline-block">
                                        <a href="/dashboard/process/category/{{ $categories_id }}/value/{{ $alternative->id }}/edit" class="btn btn-block btn-warning">Edit value</a>
                                  </div>
                                @endif
                              </td>
                            </tr>
